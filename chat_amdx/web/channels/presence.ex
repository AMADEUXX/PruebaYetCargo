defmodule ChatAmdx.Presence do
  use ChatAmdx.Web, :channel
  alias ChatAmdx.Presence
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ChatAmdx.MyChannel do
        use ChatAmdx.Web, :channel
        alias ChatAmdx.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :chat_amdx,
                        pubsub_server: ChatAmdx.PubSub
end
